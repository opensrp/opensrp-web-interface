                ...
                if(Object.keys(folder.value).length === 0) { 
                   ...
                   // section.addClass("col-sm-offset-" + options.labelColumns+level);
                    /*var sectionTitle = $("<div>")
                        ...
                        .html(regularCase(fieldName));
                    section.append(sectionTitle);*/
                    section.append(editableLabelFieldGroup(fieldName));

                    var inputRow = $("<div>").addClass("col-sm-" + options.inputColumns);
                    ...
                    $.each(fieldValue, function (i, item) {
                        comboBox.append($('<option>', { 
                            value: item.split("#")[1],
                            text : item.split("#")[0]
                        }));
                    });
                    //section.append(comboBox);
                    inputGroup.append(comboBox);
