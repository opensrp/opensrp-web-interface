		...
		<div class="card-body">
			<div class="table-responsive">
				<div id="dataTable_wrapper"
					...
					<div class="row">
						<div class="col-sm-12">
							<table class="display" id="facilityWorkers"
								   style="width: 100%;">
								<thead>
								<tr>
									...
									<th tabindex="0" rowspan="1" colspan="1"
										style="width: 140px;"><spring:message code="lbl.mhvID"/></th>
									<th tabindex="0" rowspan="1" colspan="1"
										style="width: 79px;"><spring:message code="lbl.location"/></th>
									<%--													<th tabindex="0" rowspan="1" colspan="1"--%>
								...
								<tbody>
								<%
									List<Object[]> facilityWorkers = (List<Object[]>) session.getAttribute("facilityWorkers");
									for (Object[] worker: facilityWorkers) {
								%>
								<tr>
									<td><%=worker[0]%></td>
									<td><%=worker[4]%></td>
