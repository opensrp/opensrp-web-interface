...
<c:url var="report_url" value="/report/dm-timestamp-report-am-wise" />

<c:url var="branch_wise_am_report_url" value="/report/am-timestamp-report-branch-wise" />

<c:url var="provider_wise_am_timestamp_report_url" value="/report/am-timestamp-report-provider-wise" />
...
<div class="page-content-wrapper">
    <div class="page-content">
    	<ul class="page-breadcrumb breadcrumb">
			<li>
				<i class="fa fa-star" id="size_star" aria-hidden="true"></i> <span class="sub-menu-title"><strong>Timestamp Report </strong> </span>  <a  href="<c:url value="/"/>">Home</a>
				 
			</li>
			<li>
				 /  Report  <b> / Timestamp  Report DM</b> 
			</li>
		</ul>
    ...
    <script>
        jQuery(document).ready(function() {
            ...
            getReportData('${report_url}',"Area manager wise timestamp report");
    ...
    <script>
        ...
        function filter(){
            ...
            var title = "Area manager wise timestamp report";
            if(branchIds!='' ){
                url = '${provider_wise_am_timestamp_report_url}';
