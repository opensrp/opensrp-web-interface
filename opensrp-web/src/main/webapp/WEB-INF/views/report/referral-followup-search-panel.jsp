...
<div class="portlet box blue-madison">
    ...
    <div class="portlet-body">
        ...
        <div class="row">
            <div class="col-md-3">
                <label><spring:message code="lbl.referralReason"/></label>
                <select class="custom-select custom-select-lg mb-3" id="referralReason"
                        name="referral-reason">
                    <option value="all">All</option>
                    <option value="child_problems"> Child problems</option>
                    <option value="pregnancy_problems"> Pregnancy problems</option>
