...
<c:url var="report_url" value="/pm-dfs-report-table" />

<c:url var="branch_wise_am_report_url" value="/am-dfs-report-by-branch-table" />

<c:url var="sk_wise_am_dfs_report_url" value="/am-dfs-report-by-sk-table" />
<c:url var="branch_wise_dm_dfs_report_url" value="/dm-dfs-report-table" />
            ...
            <div class="col-md-12">
                ...
                <div class="portlet box blue-madison">
                    <div class="portlet-title">
                        <div class="caption">
                            <i class="fa fa-list"></i>DFS report
                        </div>
                    </div>
                    <div class="portlet-body">
                        <div class="form-group">
                            ...
                            <div class="row" id="manager">
                                <div class="col-lg-3 form-group">
                                    <label>Divisional manager </label>
                            ...
                            <jsp:include page="/WEB-INF/views/report/dfs/search-panel.jsp" />
                        </div>

                        <div class="row" style="margin: 0px">
                            <div class="col-sm-12" id="content" style="overflow-x: auto;">
                                <h3 id="reportTile" style="font-weight: bold;">Divisional manager wise dfs report</h3>
                                <div id="report"></div>
...
<script>
    jQuery(document).ready(function() {
        ...
        getReportData('${report_url}',"Divisional manager wise dfs report");
...
<script>
    ...
    function filter(){
        ...
        var branchIds =  $("#branchList").val();
        var title = "Divisional manager wise dfs report";
        let url = '${report_url}';
        if( branchIds ==null || typeof branchIds == 'undefined'){
            branchIds = ''
        }else{
        ...
        /* if(managerOrLocation =='managerWise'){
          ...
          $("#reportTile").html("Location Wise report");
            ...
            if( branchIds !=''){
                url = '${sk_wise_am_dfs_report_url}';
                title ="SK wise dfs report";
            } else if(AM!=0 && branchIds==''){
                url = '${branch_wise_am_report_url}';
                title ="Branch wise dfs report";
            }else if(divM !=0 && AM==0 && branchIds=='' ){
                url = '${branch_wise_dm_dfs_report_url}';
                title= "Area manager wise dfs report";
            }
