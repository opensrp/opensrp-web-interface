...
<c:url var="branch_wise_report_url" value="/am-dfs-report-by-branch-table" />

<c:url var="report_url" value="/am-dfs-report-by-sk-table" />
                    ...
                    <div class="portlet-body">
                        ...
                        <div class="row" style="margin: 0px">
                            <div class="col-sm-12" id="content" style="overflow-x: auto;">
                                <h3 id="reportTile" style="font-weight: bold;">DFS report</h3>
                                <div id="report"></div>
