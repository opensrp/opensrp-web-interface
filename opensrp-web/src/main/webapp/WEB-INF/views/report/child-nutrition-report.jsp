...
<div class="page-content-wrapper">
    <div class="page-content">
    	<ul class="page-breadcrumb breadcrumb">
			<li>
				<i class="fa fa-star" id="size_star" aria-hidden="true"></i> <span class="sub-menu-title"><strong>Miscellaneous Report</strong> </span>  <a  href="<c:url value="/"/>">Home</a>
				 
			</li>
			<li>
				 /  Report  <b> / Miscellaneous  Report </b> 
			</li>
		</ul>
