...
<script>
    jQuery(document).ready(function() {
        ...
        getReportData('${dm_wise_hr_report}',"Divisional manager wise hr report");
...
<script>
    ...
    function filter(){
        let divM = $("#divM option:selected").val();
        let AM = $("#AM option:selected").val();
        var title = "Divisional manager wise hr report";
        ...
        if(divM !=0 && AM==0){
            ...
            url = '${dm_wise_hr_report}';
            title ="Divisional Manager Wise HR Report";
        }
