...
<title><spring:message code="lbl.aggregatedBiometricReport"/></title>
...
<div class="page-content-wrapper">
    <div class="page-content">
    	<ul class="page-breadcrumb breadcrumb">
			<li>
				<i class="fa fa-star" id="size_star" aria-hidden="true"></i> <span class="sub-menu-title"><strong>Aggregated Biometric Report</strong> </span>  <a  href="<c:url value="/"/>">Home</a>
				 
			</li>
			<li>
				 /  Report  <b> / Aggregated Biometric Report </b> 
			</li>
		</ul>
        ...
        <div class="portlet box blue-madison">
            <div class="portlet-title">
                <div class="caption">
                    <i class="fa fa-list"></i><spring:message code="lbl.aggregatedBiometricReport"/>
                </div>
            </div>
...
<script>
    ...
    $(document).ready(function() {
        ...
        generateAggregatedBioMetricReport();
    });
    ...
    function generateAggregatedBioMetricReport() {
        let url = "/opensrp-dashboard/report/aggregated-biometric-table";
        $.ajax({
            type : "GET",
