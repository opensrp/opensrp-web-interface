...
%>
<c:url var="report_table" value="/report/referral-followup-report-table" />

<!DOCTYPE html>
<html lang="en">

<title><spring:message code="lbl.referralFollowupReport"/></title>
...
<%--        </div>--%>
        ...
        <div class="portlet box blue-madison">
            <div class="portlet-title">
                <div class="caption">
                    <i class="fa fa-list"></i><spring:message code="lbl.referralFollowupReport"/>
                </div>
            </div>
            <div class="portlet-body">
                ...
                <div class="row" style="margin: 0px">
                    <div class="col-sm-12" id="content" style="overflow-x: auto;">
                        <div id="referral-followup-report"></div>
                    </div>
                </div>
            </div>
        </div>
