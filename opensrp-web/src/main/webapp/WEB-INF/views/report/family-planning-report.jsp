...
<div class="page-content-wrapper">
    <div class="page-content">
	    <ul class="page-breadcrumb breadcrumb">
			<li>
				<i class="fa fa-star" id="size_star" aria-hidden="true"></i> <span class="sub-menu-title"><strong>Family Planing report</strong> </span>  <a  href="<c:url value="/"/>">Home</a>
				 
			</li>
			<li>
				 /  Report  <b> / Family Planing report </b> 
			</li>
		</ul>
        ...
        <div class="portlet box blue-madison">
            <div class="portlet-title">
                <div class="caption">
                    <i class="fa fa-list"></i><spring:message code="lbl.familyPlanningReport"/>
                </div>
            </div>
