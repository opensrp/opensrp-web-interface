...
<div class="page-content-wrapper">
	...
	<ul class="page-breadcrumb breadcrumb">
			<li>
			<i class="fa fa-star" id="size_star" aria-hidden="true"></i> <span class="sub-menu-title"><strong>Edit user</strong> </span>  <a  href="<c:url value="/"/>">Home</a>
			</li>
			<li> /  User list / <b>Edit user</b>  / 
			</li>
