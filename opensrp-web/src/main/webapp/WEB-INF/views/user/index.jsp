				...
				<div class="card mb-3">
					...
					<div class="card-body">
						<div class="table-responsive">
							<table class="table display" id="userList">
								<thead>
								<tr>
								...
								<tr>
									...
									<td>
										...
										<a class="badge badge-info" href="<c:url value="/user/${id}/edit.html?lang=${locale}"/>"><spring:message code="lbl.edit"/></a> |  <%} %>
										<% if(AuthenticationManagerUtil.isPermitted("PERM_WRITE_USER")){ %>
										<a class="badge badge-success" href="<c:url value="/user/${id}/catchment-area.html?lang=${locale}"/>"><spring:message code="lbl.catchmentArea"/></a> <%} %>
									</td>
								</tr>
								<%
									}
