...
<title><spring:message code="lbl.userHiearchy"/> </title>
<%@page import="org.json.JSONObject" %>
<%@page import="org.json.JSONArray" %>
<jsp:include page="/WEB-INF/views/css.jsp" />
</head>
<% 
JSONArray userTreeData = (JSONArray)session.getAttribute("userTreeData");	
%>
		...
		<div class="form-group">				
			...
			<div class="card mb-3">
				<div class="card-header">
					<spring:message code="lbl.userHiearchy"/>
				</div>
				<div class="card-body">
