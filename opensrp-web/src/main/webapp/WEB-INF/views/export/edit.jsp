...
<c:url var="saveUrl" value="/export/${Id}/edit.html?lang=${locale}" />
					...
					<div class="row">
						...
						<div class="col-sm-5">
							<form:select path="column_names" name="to[]" id="multiselect_to"
								...
								<%
									if (session.getAttribute("preselectedOptions") != null) {
										List<String> preselectedOptions = (List<String>) session.getAttribute("preselectedOptions");
										for(String option: preselectedOptions) {
