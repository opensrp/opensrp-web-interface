...
<div class="page-content-wrapper">
		...
		<ul class="page-breadcrumb breadcrumb">
			<li>
				<i class="fa fa-star" id="size_star" aria-hidden="true"></i> <span class="sub-menu-title"><strong>Target vs achievement visit report</strong> </span>  <a  href="<c:url value="/"/>">Home</a>
				 
			</li>
			<li>
				 /  Report  <b> / Target vs achievement visit report(DM) </b> 
			</li>
		</ul>
...
jQuery(document).ready(function() {       
	 Metronic.init(); // init metronic core components
		...
		getReportData('${report_url}',"Area manager wise visit report");
