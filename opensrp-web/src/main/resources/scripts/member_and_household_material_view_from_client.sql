...
WHERE (e.json ->> 'eventType'::text) ~~ '%Registration%'::text AND c.json->>'gender' != 'H' AND (c.json->>'dateCreated') BETWEEN '2019-07-15T00:00:00.000+06:00' AND '2019-07-16T23:59:59.999+06:00'
WITH DATA;
