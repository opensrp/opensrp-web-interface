...
@Component
public abstract class OpenmrsCredentialsService {
	...
	public OpenmrsCredentialsService() {	}
	
	public OpenmrsCredentialsService(String openmrsUrl, String user, String password) {
