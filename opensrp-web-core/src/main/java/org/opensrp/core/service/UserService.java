...
public class UserService {
	...
	public <T> int update(T t) throws Exception {
		...
		if (user.isEnabled() == false)
			usersCatchmentAreaService.deleteByUser(user.getId());
	...
	public JSONObject getUserDataOfDataTable(Integer draw, Integer totalUserWithoutCatchmentArea,
	                                         List<Object[]> usersWithoutCatchmentArea, boolean editPermitted)
		...
		for (Object[] objects : usersWithoutCatchmentArea) {
			...
			String edit = editPermitted && !objects[3].toString().equalsIgnoreCase("SK")
			        && !objects[3].toString().equalsIgnoreCase("SS") ? "<a href='/opensrp-dashboard/user/"
			        + objects[5].toString() + "/edit.html?lang=en'>Edit</a> | " : "";
			String catchmentArea = editPermitted ? "<a href='/opensrp-dashboard/user/" + objects[5].toString()
			        + "/catchment-area.html?lang=en'>Catchment Area</a> | " : "";
			String changePassword = editPermitted ? "<a href='/opensrp-dashboard/user/" + objects[5].toString()
			        + "/change-password.html?lang=en'>Change Password</a>" : "";
